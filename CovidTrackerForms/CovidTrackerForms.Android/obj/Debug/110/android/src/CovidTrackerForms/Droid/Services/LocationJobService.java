package CovidTrackerForms.Droid.Services;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CovidTrackerForms.Droid.Services.LocationJobService, CovidTrackerForms.Android", LocationJobService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LocationJobService.class)
			mono.android.TypeManager.Activate ("CovidTrackerForms.Droid.Services.LocationJobService, CovidTrackerForms.Android", "", this, new java.lang.Object[] {  });
	}
